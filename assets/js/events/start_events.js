...
$(function ()
{
    ...
    // Form requests
        ...
        {
            // Wait animation
            let wait = new wtools.ElementState('.table_forms_all_notification', true, 'block', new wtools.WaitAnimation().for_block);
                        ...
                        ,`<td scope="row">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item form_modify_button" form_id="${row.id}" form_name="${row.name}">
                                            Editar
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item form_delete_button" form_id="${row.id}" form_name="${row.name}">
                                            Eliminar
                                        </a>
                                    </li>
                                </ul>
        ...
        form_read();
        $('.button_forms_read').click(() => form_read());
        ...
        $('.form_forms_add').submit((e) =>
        {
            ...
            // Wait animation
            let wait = new wtools.ElementState('.form_forms_add button[type=submit]', true, 'button', new wtools.WaitAnimation().for_button);
        ...
        $(document).on("click", '.form_modify_button', (e) =>
        {
            ...
            $('.form_forms_modify').submit((e) =>
            {
                ...
                // Wait animation
                let wait = new wtools.ElementState('.form_forms_modify button[type=submit]', true, 'button', new wtools.WaitAnimation().for_button);
        ...
        $(document).on("click", '.form_delete_button', (e) =>
        {
            ...
            $('.form_forms_delete').submit((e) =>
            {
                ...
                // Wait animation
                let wait = new wtools.ElementState('.form_forms_delete button[type=submit]', true, 'button', new wtools.WaitAnimation().for_button);
